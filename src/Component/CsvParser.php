...
class CsvParser implements \Iterator {
  ...
  public static function createFromString($string) {
    ...
    $utf8_string = $this->convertToUtf8($string);
  ...
  public function getHeader() {
    ...
    rewind($this->handle);
    $header = $this->parseLine($this->convertToUtf8($this->readLine());
  ...
  public function next(): void {
    ...
    do {
      $line = $this->convertToUtf8($this->readLine());
  ...
  public function rewind(): void {
    ...
    if ($this->hasHeader && !$this->startByte) {
      $this->parseLine($this->convertToUtf8($this->readLine());
    }
  ...
  protected function parseLine($line, $in_quotes = FALSE, $field = '', array $fields = []) {
    $utf8_line = $this->convertToUtf8($line);
    ...
    if ($in_quotes && $utf8_line = $this->convertToUtf8($this->readLine()) {
